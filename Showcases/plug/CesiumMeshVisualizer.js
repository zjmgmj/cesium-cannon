;(function(f) {
  ...
  */
					ArrowGeometry.createGeometry = function(arrowGeometry) {
						...
						var line = Cesium.CylinderGeometry.createGeometry(
						...
						var arrow
						if (reverse) {
							arrow = Cesium.CylinderGeometry.createGeometry(
								new Cesium.CylinderGeometry({
									length: headLength,
									topRadius: headWidth,
									bottomRadius: 0
  ...
  */
					BasicGeometry.createGeometry = function(basicGeometry) {
						...
						var indices =
							basicGeometry.indices instanceof Int32Array
								? basicGeometry.indices
								: new Int32Array(basicGeometry.indices)
							...
							position: new Cesium.GeometryAttribute({
								...
								values:
									positions instanceof Float32Array
										? positions
										: new Float32Array(basicGeometry.positions)
							})
						}
						if (normals) {
			...
			3: [
				function(require, module, exports) {
					...
					function BasicMeshMaterial(options) {
						...
						options.uniforms.ambientColor = Cesium.defaultValue(options.uniforms.ambientColor, [
							0,
							0,
							0,
							1.0
						])
						options.uniforms.emissionColor = Cesium.defaultValue(options.uniforms.emissionColor, [
							0,
							0,
							0,
							1.0
						])
						options.uniforms.diffuseColor = Cesium.defaultValue(options.uniforms.diffuseColor, [
							0,
							0,
							0,
							1.0
						])
						options.uniforms.specularColor = Cesium.defaultValue(options.uniforms.specularColor, [
							0,
							0,
							0,
							1.0
						...
						if (options.uniforms.diffuseColorMap) {
							...
							if (typeof options.uniforms.diffuseColorMap === 'string') {
								...
								diffuseColorMap instanceof HTMLCanvasElement ||
				...
				{ '../Util/Path.js': 35, './MeshMaterial.js': 9, './Shaders/ShaderChunk.js': 19 }
			],
			4: [
				function(require, module, exports) {
					'use strict'
					...
					GeometryUtils.isGeometry3js = function(geometry) {
						return (
							(typeof THREE !== 'undefined' &&
								(geometry instanceof THREE.Geometry || geometry instanceof THREE.BufferGeometry)) ||
						...
						for (var i = 0; i < positions.length; i += 3) {
							...
							geometry3js.vertices.push(
								new THREE.Vector3(
									...
									positions[positionIdx + 2],
									positions[positionIdx + 1]
								)
							)
						}
  ...
  */
					GeometryUtils.toCSG = function(geometry, offset) {
						...
						for (var i = 0; i < geometry.indices.length; i += 3) {
							...
							vertices.push(
								new _CSG2.default.Vertex(
									[
										positions[positionIdx++] + offset.x,
										positions[positionIdx++] + offset.y,
										positions[positionIdx++] + offset.z
									],
  ...
  */
							...
							for (j = 0; j < polygons[i].vertices.length; j++) {
								vertices.push(
									this.getGeometryVertice(
										positions,
										normals,
										polygons[i].vertices[j].pos,
										polygons[i].plane.normal
									)
								)
							}
					...
					GeometryUtils._toCSG3js = function(three_model, offset, rotation) {
						...
						for (i = 0; i < geometry.faces.length; i++) {
							if (geometry.faces[i] instanceof THREE.Face3) {
								...
								vertices.push(
									new _CSG2.default.Vertex(
										geometry.vertices[geometry.faces[i].d]
											.clone()
											.add(offset)
											.applyMatrix4(rotation_matrix),
										[
					...
					GeometryUtils._fromCSG3js = function(csg_model) {
						...
						for (i = 0; i < polygons.length; i++) {
							...
							for (j = 0; j < polygons[i].vertices.length; j++) {
								vertices.push(
									GeometryUtils._getGeometryVertice3js(three_geometry, polygons[i].vertices[j].pos)
								)
							}
							if (vertices[0] === vertices[vertices.length - 1]) {
								vertices.pop()
							...
							for (var j = 2; j < vertices.length; j++) {
								face = new THREE.Face3(
									...
									vertices[j - 1],
									vertices[j],
									new THREE.Vector3().copy(polygons[i].plane.normal)
								)
					...
					GeometryUtils._getGeometryVertice3js = function(geometry, vertice_position) {
						...
						geometry.vertices.push(
							new THREE.Vector3(vertice_position.x, vertice_position.y, vertice_position.z)
						)
  ...
  */
					function LOD(options) {
						...
						this._rotation = Cesium.defaultValue(options.rotation, {
							...
							return function update(parentModelMatrix, frameState) {
								...
								if (levels.length > 1) {
									if (this._modelMatrixNeedsUpdate) {
										_RendererUtils2.default.computeModelMatrix(
											parentModelMatrix,
											this.position,
											this.rotation,
											this.scale,
									...
									var distance = Math.max(
										0.0,
										Cesium.Cartesian3.distance(bs.center, frameState.camera.positionWC) - bs.radius
									)
									...
									show =
										show &&
										frameState.cullingVolume.computeVisibility(this._boundingSphere) !==
					...
					Object.defineProperties(LOD.prototype, {
						...
						parent: {
							...
							set: function set(val) {
								if (
									val &&
									((val._children && Array.isArray(val._children)) ||
  ...
  */
					MaterialUtils.updateMaterialFrom3js = function(materialWidth3js) {
						...
						//} else {
						m_uniforms.ambientLightColor = {
							value: new Cesium.Color(0.06666666666666667, 0.06666666666666667, 0.06666666666666667)
						}
						//}
					}
   ...
   */
					...
					function refreshUniformsCommon(uniforms, material) {
						...
						if (material.emissive) {
							var val3js = new material.emissive.constructor()
					...
					function bindUniformValue(valCesium, val3js) {
						...
						if (
							typeof valCesium.value !== 'undefined' &&
							valCesium.value != null &&
  ...
  */
					function Mesh(options) {
						...
						if (
							...
							this.material instanceof _MeshPhongMaterial2.default &&
					...
					Mesh.isGeometrySupported = function(geometry) {
						var supported =
							...
							geometry instanceof _CSG2.default ||
							typeof geometry.constructor.createGeometry == 'function' ||
							_GeometryUtils2.default.isGeometry3js(geometry)
						return supported
					}
   ...
   */
					Mesh.prototype.addInstance = function(instance) {
						...
						instance.boundingSphere = new Cesium.BoundingSphere(
							new Cesium.Cartesian3(),
							this.geometry.boundingSphere ? this.geometry.boundingSphere.radius : 0
						)
  ...
  */
					function MeshMaterial(options) {
							...
							for (var i in srcUniforms) {
								if (srcUniforms.hasOwnProperty(i) && Cesium.defined(srcUniforms[i])) {
									...
									if (
										...
										srcUniforms[i] = new Cesium.Color(
											srcUniforms[i][0],
											srcUniforms[i][1],
											srcUniforms[i][2],
											srcUniforms[i][3]
									...
									if (srcUniforms[i].hasOwnProperty('uuid')) {
										;(0, _defineProperty2.default)(val, 'uuid', srcUniforms[i].uuid, function(
											changed,
											owner
										) {
										...
										;(0, _defineProperty2.default)(val, 'uuid', Cesium.createGuid(), function(
											changed,
											owner
										) {
											owner.needsUpdate = changed
									...
									if (srcUniforms[i].hasOwnProperty('value')) {
										;(0, _defineProperty2.default)(val, 'value', srcUniforms[i].value, function(
											changed,
											owner
										) {
											owner.needsUpdate = changed
										...
										;(0, _defineProperty2.default)(val, 'value', srcUniforms[i], function(
											changed,
											owner
										) {
											owner.needsUpdate = changed
						...
						;(0, _defineProperty2.default)(
							this,
							'translucent',
							Cesium.defaultValue(options.translucent, false),
							onPropertyChanged
						)
						;(0, _defineProperty2.default)(
							this,
							'wireframe',
							Cesium.defaultValue(options.wireframe, false),
							onPropertyChanged
						)
						;(0, _defineProperty2.default)(
							this,
							'side',
							Cesium.defaultValue(options.side, MeshMaterial.Sides.DOUBLE),
							onPropertyChanged
						)
						...
						;(0, _defineProperty2.default)(
							this,
							'uniformStateUsed',
							Cesium.defaultValue(options.uniformStateUsed, [
								{
						...
						;(0, _defineProperty2.default)(
							this,
							'vertexShader',
							Cesium.defaultValue(options.vertexShader, this._vertexShader),
							onPropertyChanged
						)
						;(0, _defineProperty2.default)(
							this,
							'fragmentShader',
							Cesium.defaultValue(options.fragmentShader, this._fragmentShader),
							onPropertyChanged
						)
  ...
  */
				...
				{ './MeshMaterial.js': 9, './Shaders/phong_frag.js': 25, './Shaders/phong_vert.js': 26 }
			],
			11: [
				function(require, module, exports) {
					'use strict'
   ...
   */
			...
			12: [
				function(require, module, exports) {
					...
					function createInstancedAttributes(
						collection,
						context,
      ...
      */
						createDrawCommand: function createDrawCommand(mesh, frameState) {
							...
							var command = new Cesium.DrawCommand({
								...
								modelMatrix:
									mesh._instances && mesh._instances.length > 0
										? undefined
										: Matrix4.clone(this.modelMatrix),
								owner: mesh,
								primitiveType: geometry.primitiveType,
								cull: false, // material.cullFrustum,
								instanceCount:
									mesh._instances && mesh._instances.length > 0
										? mesh._availableInstances.length
										: undefined,
							...
							if (mesh._instances && mesh._instances.length) {
								...
								maxAttribLocation = createInstancedAttributes(
									mesh,
									frameState.context,
									vertexArrayAttributes,
									attributeLocations,
							...
							command.uniformMap.czm_instanced_modifiedModelView = this.getModifiedModelViewCallback(
								context,
								mesh
							)
							...
							fs = new Cesium.ShaderSource({
								sources: [shader.fragmentShader],
								pickColorQualifier:
									mesh._instances && mesh._instances.length
										? 'varying'
										: material.pickColorQualifier || 'uniform'
							})
							// if (this.onlySunLighting) {
							fs.defines.push('ONLY_SUN_LIGHTING')
							// }
      ...
      */
						getUniformMap: function getUniformMap(material, frameState) {
									...
									if (!that._textureCache[item.uuid] || item.needsUpdate) {
										if (!callback.allLoaded && !callback.isLoading) {
											...
											for (var i = 0; i < item.value.length; i++) {
												if (
													item.value[i] instanceof HTMLCanvasElement ||
							...
							function createTexture(texture, context) {
								...
								var npot =
									!CesiumMath.isPowerOfTwo(source.width) || !CesiumMath.isPowerOfTwo(source.height)
												...
												if (extension == 'tif') {
													...
													loadArrayBuffer(url)
														.then(function(imageArrayBuffer) {
															...
															that._textureCache[cacheKey] = onTextureImageLoaded(
																tiffCanvas,
																item
															)
															if (item.onDispose) {
							...
							if (material.uniforms) {
								var setUniformCallbackFunc = function setUniformCallbackFunc(name, item) {
									if (item !== undefined && item !== null) {
										...
										if (
											item.value instanceof Cesium.Cartesian2 ||
											...
											uniformMap[name] = function() {
												if (
													!that._framebufferTextures[item.uuid] ||
								...
								for (var name in uniforms) {
									if (
										uniforms.hasOwnProperty(name) &&
										Cesium.defined(uniforms[name].value) &&
      ...
      */
          ...
          uniform vec3 u_cameraPosition;\n'
							...
							if (material.vertexShader) {
								...
								var vs =
									getAttributeDefineBlok(material.vertexShader) + uniforms + material.vertexShader
       ...
       */
					...
					MeshVisualizer.prototype._computeModelMatrix = function(mesh, frameState) {
						...
						var that = this
						if (
							mesh instanceof _LOD2.default ||
							mesh instanceof _ReferenceMesh2.default ||
							typeof mesh.update === 'function'
						) {
							if (mesh.parent) {
								if (mesh.parent == that) {
							...
							if (mesh.parent instanceof _LOD2.default) {
								...
								if (mesh.parent && mesh.parent.modelMatrix) {
									var actualModelMatrix = mesh.parent.modelMatrix
										? mesh.parent.modelMatrix
										: mesh._drawCommand.modelMatrix
									_RendererUtils2.default.computeModelMatrix(
										actualModelMatrix,
										mesh.position,
										rotation,
  ...
  */
					MeshVisualizer.prototype.update = function(frameState) {
						...
						if (this._modelMatrixNeedsUpdate) {
							this._actualModelMatrix = _RendererUtils2.default.computeModelMatrix(
								this._modelMatrix,
								this._position,
								this._rotation,
								this._scale,
							...
							if (this._up && this._up.y) {
								this._actualModelMatrix = _RendererUtils2.default.yUp2Zup(
									this._actualModelMatrix,
									this._actualModelMatrix
								)
							}
							...
							function(mesh) {
								...
								if (mesh._instances && mesh._instances.length) {
									...
									if (!mesh.geometry.boundingSphere) {
										mesh.geometry.boundingSphere = Cesium.BoundingSphere.fromVertices(
											mesh.geometry.attributes.position.values
										)
									}
									...
									mesh._instances.forEach(function(instance) {
										...
										var intersect = frameState.cullingVolume.computeVisibility(
									...
									if (needsUpdate) {
										...
										for (var pn in mesh.geometry.attributes) {
											if (mesh.geometry.attributes.hasOwnProperty(pn)) {
												mesh._actualMesh.geometry.attributes[pn].needsUpdate =
													mesh.geometry.attributes[pn].needsUpdate
											}
										}
								...
								if (typeof mesh.update !== 'function') {
										...
										for (var name in mesh.geometry.attributes) {
											if (mesh.geometry.attributes.hasOwnProperty(name)) {
												if (
													...
													mesh.geometry.attributes[name].needsUpdate
												) {
													var attrLocation =
														mesh._drawCommand.vertexArray._attributeLocations[name]
													var vb =
														mesh._drawCommand.vertexArray._attributes[attrLocation]
															.vertexBuffer
									...
									if (mesh._instances && mesh._instances.length) {
										...
										mesh._pickCommand &&
											(mesh._pickCommand.instanceCount = mesh._availableInstances.length)
									} else {
										if (!mesh._drawCommand.boundingVolume) {
											...
											mesh._drawCommand.boundingVolume = Cesium.BoundingSphere.clone(
												mesh.geometry.boundingSphere
											)
										}
										Cesium.Matrix4.getTranslation(
											mesh.modelMatrix,
											mesh._drawCommand.boundingVolume.center
										)
									}
									...
									if (frameState.passes.pick) {
										...
										mesh._drawCommand.renderState = RenderState.fromCache(
											mesh.material._renderStateOptions
										)
  ...
  */
					MeshVisualizer.prototype.initFrameBufferTexture = function(
						frameState,
						frameBufferTexture,
						viewport
					) {
						...
						if (item instanceof _FramebufferTexture2.default) {
							...
							MeshVisualizer.traverse(
								...
								function(mesh) {
									if (_MeshUtils2.default.isMesh3js(mesh)) {
										var needsUpdate =
											!mesh._actualMesh || mesh.needsUpdate || mesh.geometry.needsUpdate
										...
										if (!needsUpdate) {
											for (var pn in mesh.geometry.attributes) {
												if (mesh.geometry.attributes.hasOwnProperty(pn)) {
													mesh._actualMesh.geometry[pn].needsUpdate =
														mesh.geometry.attributes[pn].needsUpdate
												}
											}
									...
									if (!mesh._textureCommand || mesh.needsUpdate || mesh.geometry.needsUpdate) {
										...
										for (var name in mesh.geometry.attributes) {
											if (
												mesh.geometry.attributes.hasOwnProperty(name) &&
												mesh.geometry.attributes[name]
											) {
												if (
													mesh.geometry.attributes[name] &&
													...
													var attrLocation =
														mesh._textureCommand.vertexArray._attributeLocations[name]
													var vb =
														mesh._textureCommand.vertexArray._attributes[attrLocation]
															.vertexBuffer
													var arrayView = mesh.geometry.attributes[name].values
													var gl = vb._gl
													if (
														vb._sizeInBytes ==
														arrayView * arrayView.constructor.BYTES_PER_ELEMENT
													) {
														var target = vb._bufferTarget
														gl.bindBuffer(target, vb._buffer)
														gl.bufferData(target, arrayView, BufferUsage.STATIC_DRAW)
										...
										if (!vaNeedsUpdate && mesh.geometry.indexNeedsUpdate) {
											...
											if (
												vb._sizeInBytes !=
												arrayBufferView.length * arrayBufferView.constructor.BYTES_PER_ELEMENT
											) {
												vb.destroy()
										...
										if (vaNeedsUpdate) {
											...
											if (vertexArrayAttributes && vertexArrayAttributes.length) {
												command._cacehVertexArrayAttributes = vertexArrayAttributes.map(
													function(a) {
														return a
													}
												)
									...
									mesh._textureCommand.renderState = RenderState.fromCache(
										mesh.material._renderStateOptions
									)
  ...
  *@param {Cesium.FramebufferTexture}frameBufferTexture
  @param {{x:number,y:number,width:number,height:number}}viewport
  */
					MeshVisualizer.prototype.updateFrameBufferTexture = function(
						frameState,
						frameBufferTexture,
						viewport
					) {
						...
						if (item.drawCommands && item.drawCommands.length > 0) {
							...
							for (var i = 0; i < item.drawCommands.length; i++) {
								...
								item.drawCommands[i].renderState = RenderState.fromCache(
									item.drawCommands[i]._renderStateOptions
								)
							}
						}
  ...
  */
					MeshVisualizer.prototype.getPixels = function(
						frameState,
						frameBufferTexture,
						viewport,
						readState,
						...
						if (item.drawCommands && item.drawCommands.length > 0) {
							if (
								...
								if (
									...
									!frameState.context._gl.getExtension('OES_texture_float')
								) {
							...
							pixels = _RendererUtils2.default.renderToPixels(
								item.drawCommands,
								frameState,
								item._computeTexture,
								readState ? readState : viewport,
								pixels
							)
							for (var i = 0; i < item.drawCommands.length; i++) {
  ...
  */
					MeshVisualizer.traverse = function(node, traverseFunc, visibleOnly, scratchTraverseArgs) {
						...
						if (
							...
							node instanceof _LOD2.default ||
							node instanceof _ReferenceMesh2.default
						) {
  ...
  */
					function ReferenceMesh(options) {
						...
						var axisLine = _ArrowGeometry2.default.createGeometry(
							new _ArrowGeometry2.default(this._axisParameter)
						)
						var axisLineY = _ArrowGeometry2.default.createGeometry(
							new _ArrowGeometry2.default(this._axisParameterY)
						)
  ...
  */
					RendererUtils.yUp2Zup = function(srcMatrix, dstMatrix) {
						if (!yUpToZUp) {
							yUpToZUp = Cesium.Matrix4.fromRotationTranslation(
  ...
  */
					RendererUtils.computeModelMatrix = function(
						...
						if (!scratchTranslationQuaternionRotationScale)
							scratchTranslationQuaternionRotationScale = new Cesium.Matrix4()
  ...
  */
					...
					if (typeof THREE != 'undefined') {
						...
						var generateExtensions = function generateExtensions(
							extensions,
							parameters,
							rendererExtensions
						) {
							...
							for (var u in uniforms_src) {
								...
								for (var p in uniforms_src[u]) {
									...
									if (
										...
										parameter_src &&
										(parameter_src instanceof Cesium.Color ||
											parameter_src instanceof Cesium.Matrix3 ||
											parameter_src instanceof Cesium.Matrix4 ||
											parameter_src instanceof Cesium.Cartesian2 ||
											parameter_src instanceof Cesium.Cartesian3 ||
				...
				function(require, module, exports) {
					...
					CSG.cube = function(options) {
						...
						var r = !options.radius
							? [1, 1, 1]
							: options.radius.length ? options.radius : [options.radius, options.radius, options.radius]
					...
					CSG.cylinder = function(options) {
						...
						for (var i = 0; i < slices; i++) {
							...
							polygons.push(
								new CSG.Polygon([point(0, t1, 0), point(0, t0, 0), point(1, t0, 0), point(1, t1, 0)])
							)
					...
					TIFFParser.prototype = {
						...
						parseTIFF: function parseTIFF(tiffArrayBuffer, canvas) {
										...
										case 32773:
											...
											if (getHeader) {
												...
												if (header >= 0 && header <= 127) {
													...
													/*if (header === -128)*/ // Placeholder byte?
													getHeader = true
												}
											} else {
							...
							if (canvas.getContext) {
								...
								var rowsInLastStrip =
									imageLengthModRowsPerStrip === 0 ? rowsPerStrip : imageLengthModRowsPerStrip
  ...
  */
					_csg2.default.getGeometryVertice = function(positions, normals, vertice_position, plane_normal) {
						...
						for (i = 0; i < positions.length; i += 3) {
							if (
								positions[i] === vertice_position.x &&
